...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "org.edu.pradita.main/org.edu.pradita.main.user.PenjualanHarianApp"
...
@rem Execute main
"%JAVA_EXE%" %JAVA_OPTS% %MAIN_OPTS% %DEFAULT_JVM_OPTS% %*
